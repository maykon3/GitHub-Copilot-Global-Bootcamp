...
// Add the correct using for JsonData if it exists in your solution
...
public class ConsoleApp
{
    ...
    async Task<ConsoleState> SimulateBookSearch()
    {
        ...
        // For now, just return to PatronDetails state after search
    ...
    async Task<ConsoleState> SearchBooks()
    {
        ...
        // Find the first BookItem for this book
        ...
        // Check for an active loan for this BookItem
